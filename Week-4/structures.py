...
# sentence. 
def concatenate_sentences(sentenece1, sentenece2):
    sentenece1 = sentenece1.split()
    sentenece1 = sentenece1.upper(0)
    sentenece2 = sentenece2.split()
    if sentenece2[-1] == '.' or '!' or '?':
        return sentenece1 + ' ' + sentenece2
    else:
        print('Your sentenece must end with a full stop, question mqrk or qn exlamation point')
